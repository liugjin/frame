...
define(['underscore', "materialize-css"], function(_, M) {
  ...
  BaseDirective = (function() {
    ...
    BaseDirective.prototype.link = function(scope, element, attrs) {
      ...
      scope.$on('$destroy', (function(_this) {
        return function() {
          ...
          if ((_ref = scope.signalSubscription) != null) {
            _ref.dispose();
          }
          if ((_ref1 = scope.commandSubscription) != null) {
            _ref1.dispose();
          }
    ...
    BaseDirective.prototype.getStation = function(scope, id, callback, refresh) {
      var _ref, _ref1;
      if (!id) {
        scope.station = _.find((_ref = scope.project.stations) != null ? _ref.nitems : void 0, function(sta) {
    ...
    BaseDirective.prototype.setLink = function(scope, element, attrs) {
      ...
      if (scope.callbacknum === 4) {
        return typeof this.show === "function" ? this.show(scope, element, attrs) : void 0;
      }
    };
